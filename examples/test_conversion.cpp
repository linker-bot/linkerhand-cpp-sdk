...
*/
        ...
        // 张开
        std::vector<uint8_t> open_pose = {255, 255, 255, 255, 255, 255, 0, 0, 0, 0, 255, 255, 255, 255, 255, 255};
        hand.setPosition(open_pose);
        ...
        for (size_t i = 0; i < 2; i++) {
            std::vector<uint8_t> pos_1 = hand.getPosition();
        ...
        std::vector<double> pos_2 = hand.testPositionArc(open_pose);
        std::cout << "testPositionArc size:" << pos_2.size() << std::endl;
        for (size_t j = 0; j < pos_2.size(); j++) {
            std::cout << (float)pos_2[j] << " ";
        }
        std::cout << std::endl;
        ...
        std::cout << "getPositionArc size:" << state.size() << std::endl;
        for (size_t j = 0; j < state.size(); j++) {
